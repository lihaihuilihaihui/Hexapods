...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64List-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64List-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jethexa_controller_interfaces-srv:<SetFloat64List-request> is deprecated: use jethexa_controller_interfaces-srv:SetFloat64List-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetFloat64List-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jethexa_controller_interfaces-srv:data-val is deprecated.  Use jethexa_controller_interfaces-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat64List-request>)))
  ...
  "jethexa_controller_interfaces/SetFloat64ListRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat64List-request)))
  "Returns string type for a service object of type 'SetFloat64List-request"
  "jethexa_controller_interfaces/SetFloat64ListRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64List-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64List-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jethexa_controller_interfaces-srv:<SetFloat64List-response> is deprecated: use jethexa_controller_interfaces-srv:SetFloat64List-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetFloat64List-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jethexa_controller_interfaces-srv:success-val is deprecated.  Use jethexa_controller_interfaces-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat64List-response>)))
  ...
  "jethexa_controller_interfaces/SetFloat64ListResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat64List-response)))
  "Returns string type for a service object of type 'SetFloat64List-response"
  "jethexa_controller_interfaces/SetFloat64ListResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat64List)))
  ...
  "jethexa_controller_interfaces/SetFloat64List")