...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jethexa_controller_interfaces-msg:<Pose> is deprecated: use jethexa_controller_interfaces-msg:Pose instead.")))
...
(cl:defmethod orientation-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jethexa_controller_interfaces-msg:orientation-val is deprecated.  Use jethexa_controller_interfaces-msg:orientation instead.")
  (orientation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Pose>)))
  ...
  "jethexa_controller_interfaces/Pose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Pose)))
  "Returns string type for a message object of type 'Pose"
  "jethexa_controller_interfaces/Pose")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%Euler orientation~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: jethexa_controller_interfaces/Euler~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose)))
  "Returns full string definition for message of type 'Pose"
  (cl:format cl:nil "geometry_msgs/Point position~%Euler orientation~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: jethexa_controller_interfaces/Euler~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
